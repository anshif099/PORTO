    ...
    >
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-y-10 md:gap-y-0 md:gap-x-12 border-b border-white/10 pb-16 md:pb-20">
          {/* YEAR */}
          <div>
            <p className="text-[12px] md:text-[12px] tracking-[0.02em] uppercase text-[#808080] mb-3">
              Year
            </p>
            <p className="text-[24px] md:text-[24px] leading-none">2024</p>
          </div>
          ...
          <div>
            ...
            <p className="text-[24px] md:text-[24px] leading-tight">
              Xiaomi
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-[24px] md:text-[24px] leading-none">72 Hrs</p>
          </div>
        </div>
        ...
        <div className="pt-16 md:pt-20 border-b border-white/10 pb-16 md:pb-20">
          <div className="flex flex-col md:flex-row gap-10 md:gap-24">
            ...
            <div className="md:w-1/3">
              <p className="text-[18px] md:text-[18px] font-semibold tracking-[-0.02em] uppercase">
                Research
              </p>
            </div>

            {/* Right text */}
            <div className="md:w-2/3 space-y-5 text-[18px] md:text-[18px] leading-relaxed text-[#808080]">
              <p>
