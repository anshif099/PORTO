...
import blog2Bg2Left from "../assets/blog2-bg2-left.jpg";
import blog2Bg2Right from "../assets/blog2-bg2-right.jpg";
      ...
      <div className="w-full max-w-6xl mx-auto">
        <div className="grid gap-6 md:grid-cols-2 h-[65vh] md:h-[70vh]">
          ...
          <div className="w-full h-full rounded-[32px] overflow-hidden shadow-[0_22px_40px_rgba(0,0,0,0.55)]">
            <img
              src="src/assets/blog2-bg2-left.jpg" // replace with your left image path
          ...
          <div className="w-full h-full rounded-[32px] overflow-hidden shadow-[0_22px_40px_rgba(0,0,0,0.55)]">
            <img
              src="src/assets/blog2-bg2-right.jpg" // replace with your right image path
