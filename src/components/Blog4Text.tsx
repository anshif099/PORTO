    ...
    >
      ...
      <div className="w-full max-w-6xl mx-auto grid gap-12 md:grid-cols-[1.3fr,1fr]">
        ...
        fontFamily: `"Inter Display", "Inter Display Placeholder", sans-serif`,
            ...
            Unacademy Compete was an on-ground mock competition created to 
            energize students and build excitement for a new initiative. The event was 
            designed for live recording, emphasizing a high-pressure, game-show-
            style format for promotional content.
          </p>
        </div>
