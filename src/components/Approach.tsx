...
export default function Approach() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#050505] text-white font-sans overflow-hidden relative flex flex-col">
      <style>{`
        :root {
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 py-12 flex flex-col h-full min-h-screen justify-between">
